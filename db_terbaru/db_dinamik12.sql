...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 16, 2018 at 03:57 PM
...
(0, 'dinamik.cs@upi.edu', 'admin', '21232f297a57a5a743894a0e4a801fc3', '2018-09-16 13:37:07', 'ADMSU', '', '/assets/img/icon_dashboard/admin.jpg', 1),
(1, 'dinamik.cs@upi.edu', 'ketuplak', '3ab7e6c135b8c7fc3ebd245146411e5d', '2018-09-16 13:30:05', 'ADM', '', '/assets/img/icon_dashboard/admin.jpg', 1),
...
(77, 'faishol.amirul27@gmail.com', 'faishol27', 'e4a272d5d4ab8a0e849b53a0e69045ed', '2018-09-13 14:05:14', 'PUB', '', '/assets/img/icon_dashboard/umum.jpg', 1),
...
(701, 'hamdanmiftahul@gmail.com', 'hamdanilham', '269c065f166aec7d42834a75bda86420', '2018-09-16 13:53:01', 'PUB', '', '/assets/img/icon_dashboard/umum.jpg', 1);
...
(1, 'IC', 'Ilkom Challenge', 1, 50000, 100, 'https://drive.google.com/open?id=0B6-S3m8s--tAenI0ajdrWURZX28', 'Ilkom Challenge merupakan salah satu rangkaian yang diselenggarakan oleh Mahasiswa Departemen Pendidikan Ilmu Komputer pada Dies Natalis Mahasiswa Komputer yang ke-13 (DINAMIK13) tingkat SMA/SMK sederajat se- Indonesia dengan tema “prepare yourself to face fourth industrial revolution play hard, play smart, play together and win!”.  Dimana Ilkom Challenge ini bertujuan untuk mengenalkan Universitas Pendidikan Indonesia khususnya Departemen Pendidikan Ilmu Komputer kepada siswa-siswi Sekolah Menengah Atas dan Sekolah Menengah Kejuruan se-Bandung Raya. Acara ini juga dapat juga dijadikan sebagai wadah untuk menyalurkan minat dan bakat siswa-siswi SMA/SMK sederajat  dan Umum khususnya dalam bidang basket. Pada Ilkom Challenge kali ini terdapat dua buah kategori yaitu Kompetisi Basket 5 vs 5 untuk Kalangan siswa SMA/SMK sederajat dan 3x3 untuk Umum dengan Kuota peserta yang telah dibatasi Panitia.'),
(2, 'LCW', 'Lomba Cipta Web', 1, 100000, 50, 'https://drive.google.com/open?id=0B6-S3m8s--tAa3hqOHd2aFBDZnc', 'Lomba Cipta Website merupakan kompetisi yang diselenggarakan oleh Mahasiswa Departemen Pendidikan Ilmu Komputer pada Dies Natalis Mahasiswa Komputer yang ke-13 (DINAMIK13) untuk siswa/I SMA/SMK Sederajat menuangkan ide dan kreativitas mereka kepada sebuah website, yang bertujuan untuk menuangkan ide dan sebagai sarana belajar untuk membangun dan mengembangkan sebuah website. Dengan tema “Berani beda untuk kemajuan teknologi yang kreatif dalam menghadapi revolusi industri 4.0”'),
(3, 'LDA', 'Lomba Desain Aplikasi', 1, 150000, 50, 'https://drive.google.com/open?id=0B6-S3m8s--tAVlVqTk10WEk1c0E', 'Lomba Desain Aplikasi merupakan Salah satu kompetisi yang diselenggarakan oleh Mahasiswa Departemen Pendidikan Ilmu Komputer pada Dies Natalis Mahasiswa Komputer yang ke-13 (DINAMIK13) tingkat SMA/SMK sederajat se- Indonesia. Lomba Desain Aplikasi ini diperuntukkan untuk perorangan dimana bertujuan untuk mengasah kreativitas peserta dalam mendesain sebuah aplikasi yang sesuai dengan tema dan memiliki makna yang berarti. Peserta lomba diharuskan membuat desain aplikasi berupa ilustrasi yang sesuai dengan tema LDA Dinamik13 dengan menggunakan software seperti…isi coy.\r\n	Tema dari Lomba Desain Aplikasi ini adalah “ICT sebagai langkah kreatif menuju kesuksesan industri indonesia”\r\n'),
(4, 'PCA', 'Personal Computer Assembling', 1, 95000, 50, 'https://drive.google.com/open?id=0B6-S3m8s--tAbFBYdkMzUUpYS1E', 'Lomba PCA merupakan kompetisi beradu ketepatan dan kerapihan merakit komponen – komponen kebutuhan minimum PC hingga dapat beroperasi. Lomba ini mengasah kemampuaan ketelitian dan ketepadan dalam perakitan komponen PC dengan meminimalisir penggunaan waktu. \r\nLomba ini diperuntukan untuk SMA/SMK sederajat Se-Indonesia. Pada Lomba ini terdapat  dua buah Babak yaitu BabakPenyisihan dimana akan diambil beberapa peserta terbik yang akan ditentukan oleh penilaian dewan juri untuk selanjutnya melangkah ke Babak Final.'),
(5, 'CSPC', 'Computer Science Programming Contest', 1, 50000, 50, 'https://drive.google.com/open?id=0B6-S3m8s--tANV9HZWU1eUV3Q2M', 'Computer Science Programming Contest merupakan salah satu kompetisi yang diselenggarakan oleh Mahasiswa Departemen Pendidikan Ilmu Komputer pada Dies Natalis Mahasiswa Komputer yang ke-13 (DINAMIK13) tingkat SMA/SMK sederajat se- Indonesia. Dimana  Computer Science Programming Contest (CSPC) ini menguji nalar / logika peserta dalam menyelesaikan suatu persoalan yang diberikan dengan menggunakan bahasa pemograman Pascal, C dan C++.. Kompetisi ini menggunakan sistem online judge. Peserta akan diberi sejumlah soal pemrograman (Probrem Solving) yang harus diselesaikan dalam waktu yang ditentukan kemudian mengunggah (Upload) jawaban berupa file kode program ke server panitia.'),
(6, 'LCA', 'Lomba Cipta Animasi', 1, 100000, 50, 'https://drive.google.com/open?id=0B6-S3m8s--tAQ2tIMzdZRzd6TXM', 'Lomba Cipta Animasi merupakan salah satu lomba yang mengkompetisikan kemampuan produksi sebuah film pendek animasi dan diperuntukan bagi siswa/I SMA/sederajat dengan berbentuk kelompok yang diselenggarakan oleh Mahasiswa Departemen Pendidikan Ilmu Komputer pada Dies Natalis Mahasiswa Komputer yang ke-13 (DINAMIK13)salah. Tema dari Lomba Cipta Animasi DINAMIK13 yaitu “Kreativitas Generasi Muda Sebagai Cerminan Kesiapan Menghadapi Revolusi Industri”.'),
...
(8, 'KJ', 'Kompetisi Jaringan', 1, 50000, 50, 'https://drive.google.com/open?id=0B6-S3m8s--tAVDBkdzZkcGJmVWs', 'Kompetisi Jaringan merupakan kompetisi yang diselenggarakan oleh Mahasiswa Departemen Pendidikan Ilmu Komputer pada Dies Natalis Mahasiswa Komputer yang ke-13 (DINAMIK13) untuk siswa/I SMA untuk menguji kemampuan peserta dalam menghadapi kasus keamanan sistem komputer dan jaringan yang telah disiapkan. Sistem dirancang untuk mempunyai celah atau informasi tertentu yang berakibat terhadap dimungkinkannya peretasan pada sistem tersebut. Terdapat dua bidang yang di kompetisikan dalam acara ini yaitu sistem jaringan dan desain jaringan. Kompetisi Jaringan mengusung tema \"Menghubungkan seluk beluk berbagai macam perangkat teknologi untuk revolusi Industri 4.0\". Sasaran peserta lomba ini yaitu siswa/i SMA/SMK se-Nasional.'),
(9, 'MALAM PENG', 'Malam Penganugerahaan', 1, 0, 50, NULL, 'Malam Penganugerahan merupakan Rangkaian puncak Dies Natalis Mahasiswa Ilmu \r\nKomputer ke-13 (DINAMIK13) yaitu Malam Penganugerahan untuk para Pemenang disetiap Rangkain acara DINAMIK13. Dengan tema “Transformasi skill sebagai langkah strategis menghadapi Revolusi Industri 4.0 untuk nusa bangsa”\r\n'),
(10, 'SEMNAS', 'Seminar Nasional', 1, 50000, 50, NULL, 'Seminar Nasional merupakan salah satu dari rangkain kegiatan DINAMIK13 yang merupakan sebuah seminar berskala nasional yang pematerinya berasal dari berbagai latar belakang, dan pengunjung dari seminar ini bersifat umum siapapun bisa datang ke seminar ini. Tema yang diangkat untuk tahun ini adalah “Transformasi Skill sebagai Langkah Strategis Menghadapi Revolusi Industri 4.0 untuk Nusa Bangsa”.'),
(11, 'FESTIVAL I', 'Festival IT', 1, 0, 50, NULL, 'Festival IT merupakan salah satu dari rangkaian acara di DINAMIK 13 yang bertajuk unjuk karya mahasiswa/i Departemen Pendidikan Ilmu Komputer UPI, Mahasiwa/i Indonesia, berbagai komunitas, Startup,dan Umum. Tema yang diusungkan adalah “Explore Revolution Industry with Art and Technology”. Sasaran dari kegiatan ini adalah seluruh khalayak umum.'),
...
(86, 'hamdanilham', '', '', '', 'hamdanilham', 2, 701);
...
--
ALTER TABLE `tb_account`
  MODIFY `account_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=702;
--
...
--
ALTER TABLE `tb_payment`
  MODIFY `payment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=481;
--
-- AUTO_INCREMENT for table `tb_public`
--
ALTER TABLE `tb_public`
  MODIFY `public_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;
--
-- AUTO_INCREMENT for table `tb_pubteam`
--
ALTER TABLE `tb_pubteam`
  MODIFY `pubteam_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;
--
-- AUTO_INCREMENT for table `tb_school`
--
ALTER TABLE `tb_school`
  MODIFY `school_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
--
-- AUTO_INCREMENT for table `tb_schparticipant`
--
ALTER TABLE `tb_schparticipant`
  MODIFY `schparticipant_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=665;
--
-- AUTO_INCREMENT for table `tb_schteam`
--
ALTER TABLE `tb_schteam`
  MODIFY `schteam_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=438;
--
