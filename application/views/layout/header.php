...
<html lang="en">
  ...
  <body>
    <nav class="headroom headroom--unpinned navbar navbar-inverse navbar-fixed-top nav" style="">
      <div class="collapse navbar-collapse head" style="background: #fff">
        <a href="<?php echo site_url('/'); ?>"><img class="img" src="<?php echo base_url("assets/img/logo/logo13.png"); ?>"></a>
      </div>
      <div class="container">
