...
<html>
	<head>
		...
		<style>
			...
			.form-tim input,select {
				font-size: 14px;
				width: 300px;
				padding: 5px 10px 5px 10px;
			}
			
			.form-tim input[type="submit"],input[type="button"] {
				width: 100px;
			}
			
			.form-tim input[type="text"]:disabled {
				background-color: #fff;
				color: #959595;
							...
							<li class="dropdown user user-menu">
								...
								<ul class="dropdown-menu">
									...
									<li class="user-footer">
										<div class="pull-left">
											<a href="<?php echo site_url('dashboard/tim/profil') ?>" class="btn btn-default btn-flat">Profil</a>
										</div>
